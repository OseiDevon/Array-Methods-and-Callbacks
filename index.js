...
var filterfunc = fifaData.filter(hometeam)

//(a) Home Team name for 2014 world cup final
//Home team/2014..

console.log(filterfunc[0]["Home Team Name"])

//(b) Away Team name for 2014 world cup final
//Away team/year

console.log(filterfunc[0]["Away Team Name"])

//(c) Home Team goals for 2014 world cup final
//hteam/goals/year

console.log(filterfunc[0]["Home Team Goals"])

//(d) Away Team goals for 2014 world cup final
//ateam/goal/year

console.log(filterfunc[0]["Away Team Goals"])

//(e) Winner of 2014 world cup final */
//teamwithmorepoints

if (filterfunc[0]["Home Team Goals"] > filterfunc[0]["Away Team Goals"]){
    console.log(filterfunc[0]["Home Team Name"]+'! WInner Winner')
}
//else if..
...
function getAverageGoals(data, getFinalsCB) {
  let counter = 0
   data.map((goals) =>{
       ...
       initials.forEa(element =>{
           if (element === getFinalsCB) {
               counter++;
           }
   })
   return counter;
